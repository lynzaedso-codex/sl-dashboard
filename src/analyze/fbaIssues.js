import { asText, asDate, monthKey, monthLabel, weekKey, weekLabel, groupBy, topN } from "../utils.js";
...
export function analyzeFbaIssues(rows) {
  ...
  const weeklyGroups = groupBy(normalized, (r) => r.weekKey);
  const weekly = Object.values(weeklyGroups)
    .sort((a, b) => a.key.localeCompare(b.key))
